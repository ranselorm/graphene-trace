      ...
      <div className="flex">
        ...
        <aside className="hidden md:flex md:w-64 md:flex-col border-r border-zinc-900 min-h-screen">
          <div className="p-4">
            ...
            <div className="text-lg font-semibold leading-tight">Clinician</div>
          </div>

          <Separator className="bg-zinc-900" />

          <nav className="p-3 space-y-1">
            <ShellNavLink to="/clinician" label="Overview" />
            <ShellNavLink to="/clinician/patients" label="Patients (soon)" />
            <ShellNavLink to="/clinician/alerts" label="Alerts (soon)" />
          </nav>
          ...
          <header className="sticky top-0 z-10 border-b border-zinc-900 bg-zinc-950/80 backdrop-blur">
            <div className="flex items-center justify-between px-4 py-3">
              <div className="md:hidden">
                <div className="text-sm text-zinc-400">Clinician Portal</div>
              </div>
