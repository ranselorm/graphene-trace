        ...
        <Card className="bg-zinc-900 border-zinc-800">
          <CardHeader>
            ...
            <CardDescription className="text-zinc-400">
              Use the demo accounts for now. Backend auth comes later.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent>
            ...
            <div className="mt-5 rounded-lg border border-zinc-800 bg-zinc-950 p-3">
              <div className="text-xs text-zinc-400 mb-2">Demo accounts</div>
          ...
          <CardFooter className="text-xs text-zinc-500">
            Tip: Once you sign in, you’ll land in the portal based on your role.
          </CardFooter>
        </Card>
      </div>
    </div>
